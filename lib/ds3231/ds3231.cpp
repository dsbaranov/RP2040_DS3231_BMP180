...
namespace DS3231
{
    ...
    DS3231::DS3231(i2c_inst_t *i2c) : I2CDevice(i2c, REGISTERS::DEVICE_ADDRESS, 11u)
    {
    }
    ...
    void DS3231::init()
    {
        ...
        controls.EOSC = 0;
        readState();
        State.A1F = State.A2F = 0;
        setState();
        setAlarm(domain::IAlarm2{25, 0, 0, 0, 0, 0, 0, 1, 1, 1});
        controls.INTCN = controls.A1IE = controls.A2IE = 1;
        controls.BBSQW = 0;
        setControls();
    }
